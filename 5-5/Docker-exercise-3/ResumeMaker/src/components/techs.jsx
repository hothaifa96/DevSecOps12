...
//converts the data base into the object needed for a multi select
options = options.map((e) => {
  return { value: e, label: e };
});
optionsLanguag = options;
...
const Techs = (props) => {
  ...
  return (
    ...
    >
      {/* best techs */}
      <div id="containerTechs" className="shadow-sm p-3  bg-body rounded">
        <div class="form-control mt-2">
          <div class="form-group ">
            ...
            <Select
              ...
              isMulti
              onChange={(picks) => {
                props.handleBesttechs(picks);
              }}
              isOptionDisabled={() => props.pickedMain >= 5}
            />
          </div>
